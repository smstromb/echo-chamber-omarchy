...
- The group uses Main exclusively. Prioritize Main, its participants and direct call controls; keep other rooms available under the header room dropdown. Feature parity does not require copying upstream's navigation or visual hierarchy.
...
- Selected design: option 1, adaptive main area (voice → cameras → screens), compact right people list, persistent bottom call controls. Prefer icons, hierarchy and tooltips to visible descriptions. No screen-oriented empty state when no screens exist.
